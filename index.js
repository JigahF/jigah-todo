...
const addTodo =()=>{
  if(!todoInput.value){
      ...
      formMessage.innerHTML = "Enter your task in the field above"
...
const fetchTodo =()=>{
  ...
  if(dbEmpty){
      todoWrapper.innerHTML = `<p class='text-center text-slate-400'></p>`
      return
  }
...
const updateTodo =(id)=>{
 ...
 Swal.fire(
  'Updated!',
  'Your Task have been Successfully Updated.',
  'success'
)
